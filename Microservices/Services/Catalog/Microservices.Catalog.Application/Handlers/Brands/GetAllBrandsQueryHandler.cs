...
{
    public class GetAllBrandsQueryHandler : IRequestHandler<GetAllBrandsQuery, GetAllBrandsQueryResponse>
    {
        private readonly IRepository<ProductBrandEntity, string> _repository;

        public GetAllBrandsQueryHandler(IRepository<ProductBrandEntity, string> repository)
        {
